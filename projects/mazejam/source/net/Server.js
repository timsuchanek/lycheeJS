...
lychee.define('game.net.Server').requires([
	...
	var Class = function(data) {
		...
		this.bind('connect', function(remote) {
			...
			console.log('(MazeJam) game.net.Server: Remote connected (' + remote.host + ':' + remote.port + ')');
		...
		this.bind('disconnect', function(remote) {
			...
			console.log('(MazeJam) game.net.Server: Remote disconnected (' + remote.host + ':' + remote.port + ')');
