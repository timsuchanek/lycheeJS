...
lychee.define('game.entity.Track').requires([
//	'game.entity.Background'
	...
	var Class = function(id) {
		...
		var data = _tracks['valley'];
		if (id !== null) {
			data = _tracks[id] || data;
		}
	...
	Class.prototype = {
		...
		render: function(renderer, offsetX, offsetY, camera, compositor) {
			...
			if (
				...
				var lasty  = renderer.getEnvironment().height;
